...
export default defineConfig({
  title: "证券开户免5",
  description: "证券开户 开户免5 抵佣金开户",
  themeConfig: {
    // https://vitepress.dev/reference/default-theme-config
    nav: [
      { text: '首页', link: '/' },
      { text: '行业动态', link: '/articles/markdown-examples' },
      { text: '佣金表格', link: '/articles/markdown-examples' },
      { text: '🎉 免五 开户', link: '/account-open' }
    ],
      ...
      '/articles/': [
        {
          text: '行业动态',
          items: [
            { text: '2025知名券商万0.75免五名单汇总，永久低佣', link: '/articles/api-examples' },
            { text: '一篇带你了解国债逆回购', link: '/articles/markdown-examples' },
            { text: '新开的证券账户，要先检查这些功能【附带图片收藏】', link: '/articles/markdown-examples' }
          ]
        }
      ]
    },
